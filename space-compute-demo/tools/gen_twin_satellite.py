...
SOLAR_MATERIALS = {
    ...
    # Bright bare-metal hinge pin/axle so the deployment hinge reads against the
    # painted yoke arm.
    "HingePinMetal": {"diffuse": (0.780, 0.790, 0.810), "metallic": 0.95,
                      "roughness": 0.20, "emissive": (0.0, 0.0, 0.0)},
