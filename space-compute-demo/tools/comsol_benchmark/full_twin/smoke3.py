...
a0 = stdA.create('otl', 'OrbitThermalLoads'); a0.set('timestepspec', 'timesteps'); a0.set('tlist', 'range(0,5000,20000)'); a0.set('useadvanceddisable', True); a0.set('disabledvariables', ['var_trans'])
a1 = stdA.create('ot', 'OrbitalTemperature'); a1.set('timestepspec', 'timesteps'); a1.set('tlist', 'range(0,5000,20000)'); a1.set('rtol', '0.005'); a1.set('useadvanceddisable', True); a1.set('disabledvariables', ['var_trans'])
t0 = time.time()
try:
...
b0 = stdB.create('otl', 'OrbitThermalLoads'); b0.set('timestepspec', 'timesteps'); b0.set('tlist', 'range(0,60,1800)'); b0.set('useadvanceddisable', True); b0.set('disabledvariables', ['var_stat'])
b1s = stdB.create('ot', 'OrbitalTemperature'); b1s.set('timestepspec', 'timesteps'); b1s.set('tlist', 'range(0,60,1800)'); b1s.set('rtol', '0.005'); b1s.set('useadvanceddisable', True); b1s.set('disabledvariables', ['var_stat'])
...
model.save(os.path.join(S, "smoke3.mph")); print("saved")
